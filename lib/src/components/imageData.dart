...
class ImageData extends StatelessWidget {
  ...
  //width는 인자로 넘겨받을시 그 값을 쓰고 그렇지 않다면 default로 55가 주어짐
  ImageData(this.dir, {Key? key, this.width = 55}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Image.asset(dir, width: this.width! / Get.mediaQuery.devicePixelRatio);
  }
}

//각각 이미지 path를 변수명 게터에 담음
class IconsPath {
